<template>
  <article>
    ...
    <CreationListLine v-show="povidky.length > 0"
    ...
    <h2 class="creationsSection" v-show="basnicky.length > 0">Básničky <small>Moje pokusy na poli
      poezie</small></h2>
    <CreationListLine v-show="basnicky.length > 0"
    ...
    <h2 class="creationsSection" v-show="textiky.length > 0">Textíky <small>Krátké texty, obvykle poněkud
      praštěné ;)</small></h2>
    <CreationListLine v-show="textiky.length > 0"
